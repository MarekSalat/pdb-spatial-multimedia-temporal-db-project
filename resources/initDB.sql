...
INSERT INTO XPRIKR27.PDB_COMPANY (ID, NAME, VALID_FROM, VALID_TO) VALUES ('250426869235139793', 'Lesaci Brno s.r.o.', 9483, 10957);
INSERT INTO XPRIKR27.PDB_COMPANY (ID, NAME, VALID_FROM, VALID_TO) VALUES ('250426869235139793', 'Lesaci Brno s.r.o.', 10957, 12784);
INSERT INTO XPRIKR27.PDB_COMPANY (ID, NAME, VALID_FROM, VALID_TO) VALUES ('250426869235139793', 'Lesaci Brno s.r.o.', 12784, 2932884);
INSERT INTO XPRIKR27.PDB_COMPANY (ID, NAME, VALID_FROM, VALID_TO) VALUES ('-1811051922436304899', 'Drevo Olomouc', 12784, 2932884);
INSERT INTO XPRIKR27.PDB_COMPANY (ID, NAME, VALID_FROM, VALID_TO) VALUES ('-1811051922436304899', 'Drevo Olomouc', 10957, 12784);

INSERT INTO XPRIKR27.PDB_LOGGING_HISTORY (ID, COMPANY_ID, COMPANY_NAME, LOGGING_AREA, LOGS_PER_DAY, VALID_FROM, VALID_TO) VALUES ('-3921250388357922245', '250426869235139793', 'Lesaci Brno s.r.o.', 'Luzanky', 50, 9483, 10957);
INSERT INTO XPRIKR27.PDB_LOGGING_HISTORY (ID, COMPANY_ID, COMPANY_NAME, LOGGING_AREA, LOGS_PER_DAY, VALID_FROM, VALID_TO) VALUES ('3529065332653509560', '250426869235139793', 'Lesaci Brno s.r.o.', 'Raholec', 70, 10957, 12784);
INSERT INTO XPRIKR27.PDB_LOGGING_HISTORY (ID, COMPANY_ID, COMPANY_NAME, LOGGING_AREA, LOGS_PER_DAY, VALID_FROM, VALID_TO) VALUES ('4657936613281581797', '-1811051922436304899', 'Drevo Olomouc', 'Raholec', 15, 10957, 12784);