BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE PDB_MEDIA';
    EXCEPTION
    WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
        RAISE;
...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE PDB_SPATIAL';
    EXCEPTION
    WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
        RAISE;
...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE PDB_COMPANY';
    EXCEPTION
    WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
        RAISE;
...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE PDB_LOGGING_HISTORY';
    EXCEPTION
    WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
        RAISE;
